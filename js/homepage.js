...
var [record_btn,appoint_btn] = [$(".requestRecord"),$(".appoint")];
...
appoint_btn.click(function(obj) {
	...
	$.ajax({
		...
		data: {
			...
			idcard_num: id,
			uname: name,
			// ({phone_num, idcard_num, uname} = {phone_num: phone, idcard_num: id, uname: name})
		},
		// data: {
		...
		// function(res) 
		(res) =>{	
		let{access_token} = {access_token : res.data.access_token};
