...
[more_btn,selections,times,availables] = [$(".more"),$(".option"),$(".time"),$(".available")]
$.ajax({
	url: appoint_url,
	type: "post",
	data: {
							...
							$.ajax({
								...
								success: function(ele) {
									...
									if (ele.res == 0) {
										...
										isClick = true
										// MtaH5.clickStat('book_success',{'booktime': JSON.stringify(day_time + show_id) })
										MtaH5.clickStat('book_success', {
											'booktime': JSON.stringify(day_time + " + " + show_id)
										})
										location.href = "welcome.html" + "?" + "access_token" + "=" + access_token + "&" + "uname" + "=" +
											escape(uname) + "&" + "show_id" + "=" + show_id + "&" + "day_time" + "=" + day_time + "&" +
											"show_id" + "=" + show_id;
										// 			console.log("welcome.html" + "?" + "access_token" + "=" + access_token + "&" + "uname" + "=" + escape(uname) + "&" + "show_id" + "=" + show_id + "&" + "day_time" + "=" + day_time + "&" + "show_id" + "=" + show_id)
									}
								}
							})
						}
